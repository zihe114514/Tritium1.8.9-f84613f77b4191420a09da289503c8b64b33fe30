 ...
 * Date: 2026/4/1 08:26
 */
public class TritiumEventHandler implements EventHandler {

    @Getter
    private static final TritiumEventHandler instance = new TritiumEventHandler();

    @Getter
    private static final Logger logger = LogManager.getLogger("TritiumEventHandler");
