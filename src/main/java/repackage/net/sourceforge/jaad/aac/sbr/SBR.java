package repackage.net.sourceforge.jaad.aac.sbr;

import java.util.Arrays;
import repackage.net.sourceforge.jaad.aac.AACException;
import repackage.net.sourceforge.jaad.aac.SampleFrequency;
import repackage.net.sourceforge.jaad.aac.ps.PS;
import repackage.net.sourceforge.jaad.aac.syntax.BitStream;

public class SBR implements Constants, repackage.net.sourceforge.jaad.aac.syntax.Constants, HuffmanTables {
