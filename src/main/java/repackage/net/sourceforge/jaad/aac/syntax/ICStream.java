...
import repackage.net.sourceforge.jaad.aac.ChannelConfiguration;
import repackage.net.sourceforge.jaad.aac.DecoderConfig;
import repackage.net.sourceforge.jaad.aac.error.RVLC;
import repackage.net.sourceforge.jaad.aac.gain.GainControl;
import repackage.net.sourceforge.jaad.aac.huffman.HCB;
import repackage.net.sourceforge.jaad.aac.huffman.Huffman;
import repackage.net.sourceforge.jaad.aac.tools.TNS;
