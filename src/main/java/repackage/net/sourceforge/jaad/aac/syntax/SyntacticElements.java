...
import repackage.net.sourceforge.jaad.aac.*;
import repackage.net.sourceforge.jaad.aac.filterbank.FilterBank;
import repackage.net.sourceforge.jaad.aac.sbr.SBR;
import repackage.net.sourceforge.jaad.aac.tools.IS;
import repackage.net.sourceforge.jaad.aac.tools.LTPrediction;
import repackage.net.sourceforge.jaad.aac.tools.MS;
